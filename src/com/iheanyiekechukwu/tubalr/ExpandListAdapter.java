...
public class ExpandListAdapter extends BaseExpandableListAdapter {
	...
	public Object getChild(int groupPosition, int childPosition) {
		...
		// groups.get(groupPosition).getArrayChildren().get(childPosition);
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (view == null) {
			view = inflater.inflate(R.layout.expand_list_child_item, parent,
					false);
		}

		TextView tv = (TextView) view.findViewById(R.id.tvChild);

		tv.setText(groups.get(groupPosition).getArrayChildren()
				.get(childPosition));
	...
	public void addItem(ListChild item, ListGroup group) {
		...
		/*
		 * ArrayList<ListChild> ch = groups.get(index).getItems(); ch.add(item);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View view,
		...
		if (view == null) {
			view = inflater.inflate(R.layout.expand_list_group_item, parent,
					false);
		}
