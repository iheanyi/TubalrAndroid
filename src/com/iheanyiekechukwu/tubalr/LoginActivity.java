...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final CheckBox actionCheckBox = (CheckBox) findViewById(R.id.registerCheckBox);
	...
	public void attemptLogin() throws UnsupportedEncodingException {
		...
		if (cancel) {
			...
			String loginURL = "http://www.tubalr.com/api/sessions.json?email_or_username="
					+ mEmail + "&password=" + URLEncoder.encode(mPassword, "UTF-8");

			String relativeURL = "api/sessions.json?email_or_username="
					+ mEmail + "&password=" + mPassword;

			AsyncHttpClient client = new AsyncHttpClient();
			
			RequestParams params = new RequestParams();
			params.put("email_or_username", mEmail);
			params.put("password", mPassword);
			PersistentCookieStore myCookieStore = new PersistentCookieStore(
					this);
			client.setCookieStore(myCookieStore);
			client.setBasicAuth("email_or_username", "password");
			...
			client.post(loginURL, params, new JsonHttpResponseHandler() {
				...
				public void onSuccess(JSONObject result) {
					...
					UserHelper.userInfo[UserHelper.USER] = Integer
							.toString(userID);
