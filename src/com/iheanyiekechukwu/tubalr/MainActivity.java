...
public class MainActivity extends SherlockFragmentActivity implements
		OnClickListener, OnFragmentInteractionListener {

	private static final String[] CONTENT = new String[] { "Genres",
			"Subreddits", "My Playlists" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// mViewPager.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
		...
		// mSectionsPagerAdapter.addTab(bar.newTab().setText("Genres"),
		// Genres.class, null);
		// mSectionsPagerAdapter.addTab(bar.newTab().setText("Reddit"),
		// Subreddit.class, null);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1:
			if (resultCode == RESULT_FIRST_USER) {
				...
				videos = (ArrayList<VideoClass>) data
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		refresh.setVisible(UserHelper.userLoggedIn());
	...
	private final class MusicServiceConnection implements ServiceConnection {
		...
		public void onServiceConnected(ComponentName className, IBinder baBinder) {
			...
			musicService = ((MusicService.MusicServiceBinder) baBinder)
					.getService();
			musicServiceIntent = new Intent(getBaseContext(),
					MusicService.class);
	...
	private class MusicServiceBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (MusicService.UPDATE_PLAYLIST.equals(intent.getAction())) {
				...
				currentArtist
						.setText(musicService.getCurrentVideo().getTitle());
			}
		}
	...
	private void showSearchDialog() {
		...
		alert.setPositiveButton("Just", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				BugSenseHandler
						.sendEvent("User searched for Just: " + s_artist);
	...
	public static class TabsAdapter extends FragmentPagerAdapter implements
			TabListener {
		/*
		 * private final Context mContext; private final ActionBar mActionBar;
		...
		public Fragment getItem(int position) {
			...
			if (position == 0) {
				...
				return UserPlaylist.newInstance(
						UserHelper.userInfo[UserHelper.USER],
						UserHelper.userInfo[UserHelper.TOKEN]);
			}
		}
	...
	private void showAddDialog() {
		...
		alert.setPositiveButton("Add", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				stringBuilder
						.append("http://www.tubalr.com/api/playlist/create?playlist_name=");
